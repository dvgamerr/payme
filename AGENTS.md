...
- ควบคุมคุณภาพโค้ดด้วย Prettier, ESLint และ Commitlint
- ระบบ Git hooks ด้วย Husky และ lint-staged
...
1. **ใช้ Vanilla JavaScript**: เลือกใช้ JSDoc ในการทำ Documentation แทน TypeScript เพื่อลดความซับซ้อนของ Build Process
